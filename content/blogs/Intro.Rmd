...
```{r, echo=FALSE}
knitr::include_graphics("D:/MBA/Term 3/DSfB/website2/static/img/UCL.jpg")
```
...
```{r, echo=FALSE}
knitr::include_graphics("D:/MBA/Term 3/DSfB/website2/static/img/S&.jpg")
```
...
```{r, echo=FALSE}
knitr::include_graphics("D:/MBA/Term 3/DSfB/website2/static/img/lbs.jpg")
```
