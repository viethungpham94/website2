...
```{r, echo=FALSE}
knitr::include_graphics("D:/MBA/Term 3/DSfB/website2/static/img/Workforce.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("D:/MBA/Term 3/DSfB/website2/static/img/Product_Channel.png")
```
